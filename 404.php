				...
				<div class="page-content">
					...
					<div class="entry-content">
						...
						<ul>
							...
							<li><?php printf( wp_kses( __( 'Return to the <a href="%s">home page</a>', 'propane' ), array( 'a' => array( 'href' ) ) ), esc_url( home_url() ) ); ?></li>
							<li><?php printf( wp_kses( __( 'Click the <a href="%s">Back</a> button', 'propane' ), array( 'a' => array( 'href' ) ) ), esc_attr( 'javascript:history.back();' ) ); ?></li>
						</ul>
					</div>
