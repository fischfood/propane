...
if ( array_key_exists( 'secret', $_POST ) ) {
	...
	if ( 'POST' === $_SERVER['REQUEST_METHOD'] && ! empty( $_POST['action'] ) && $_POST['action'] === "maintenance-delete" && $secret === 'true' ) {

		$post_id = $_POST['maintenance-delete-id'];
	...
	if ( ! empty( $_POST['secret'] ) ) {
		wp_safe_redirect( site_url('/maintenance' ) );
	}
}