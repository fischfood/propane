...
class Propane {
	...
	function wp_enqueue_scripts() {
		wp_enqueue_script( 'propane', 	 get_stylesheet_directory_uri() . '/js/propane.js', array( 'jquery' ), PROPANE_VERSION, true );
	}
	...
	function wp_enqueue_styles() {
		wp_enqueue_style( 'app-css', get_stylesheet_directory_uri() . '/css/propane.css' );
	}
